...
export default function SpecialOffers() {
    return (
        <>
            <div className="w-12/12 md:w-10/12 m-auto py-10 border-t">
                <div className="grid grid-cols-1 md:grid-cols-5 md:space-x-3">  
                    <div className="flex flex-col col-span-2">
                        <div><Image src={logo} alt="Le REUSSI Logo" className="w-1/2 mb-3" /></div>
            ...
            <div className="bg-pizza-600 text-white w-full">
                <div className="w-12/12 md:w-10/12 m-auto py-3">
